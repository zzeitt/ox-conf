...
#+options: ^:{}
Last updated Time-stamp: <2025-11-27 15:48:06>
# ===================================================================================
# Hints:
             ...
             (if (string= name sec-name)
                 (save-restriction
                   ...
                   (if (string= (buffer-substring-no-properties (region-beginning) (region-end)) new-content)
                       (setq _msg (format "====> No new contents in %s." sec-name))
                     (progn
...
- Confluence
  ...
  - LaTeX Math
    - [[https://appfire.atlassian.net/wiki/spaces/LM/pages/77038326/Create+macros+for+wiki-markup][Create macros for wiki-markup - LaTeX Math - Confluence]]
  - Section
    - [[https://confluence.atlassian.com/conf59/section-macro-792499196.html][Section Macro | Atlassian Support | Atlassian Documentation]]
  - Column
    - [[https://confluence.atlassian.com/conf59/column-macro-792499085.html][Column Macro | Atlassian Support | Atlassian Documentation]]
  - REST API
...
- Jira
  ...
  - [[https://docs.atlassian.com/jira-software/REST/7.3.1/#agile/1.0/issue-getIssue][JIRA Agile Server 7.4.0-SNAPSHOT REST API reference]]
